...
int32_t
sys_env_inc_tickets(envid_t envid, uint16_t increment)
{
	return syscall(SYS_env_inc_tickets, 0, envid, increment, 0, 0, 0);
}

int32_t
sys_env_dec_tickets(envid_t envid, uint16_t decrement)
{
	return syscall(SYS_env_dec_tickets, 0, envid, decrement, 0, 0, 0);
}
